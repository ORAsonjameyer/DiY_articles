create or replace package wksp_mlegenai.generate_sample_data as
    ...
    */
    procedure generate_sample_email_recipients (
        ...
        mle module new_bundle_data signature 'generateSampleRecipients';
    ...
    */
    procedure generate_sample_email (
        ...
        mle module new_bundle_data signature 'generateSampleEmail';
end generate_sample_data;
/


-- sqlcl_snapshot {"hash":"f68a18bd811dbc8622257d80da1a743530b495f6","type":"PACKAGE_SPEC","name":"GENERATE_SAMPLE_DATA","schemaName":"WKSP_MLEGENAI","sxml":""}