...
-- bump sequence values

alter table OCG_GROUPS_EU modify group_id generated by default on null as identity (start with limit value);

alter table OCG_GROUP_EVENTS_2026 modify event_id generated by default on null as identity (start with limit value);

alter table OCG_COUNTRY_CODE_LOOKUP modify COUNTRY_CODE_ID generated by default on null as identity (start with limit value);
